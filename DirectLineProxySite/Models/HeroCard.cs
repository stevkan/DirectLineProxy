...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HeroCard)obj);
        }

        /// <summary>
        /// Returns true if HeroCard instances are equal
        /// </summary>
        /// <param name="other">Instance of HeroCard to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(HeroCard left, HeroCard right)
        {
