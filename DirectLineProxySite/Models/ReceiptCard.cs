...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ReceiptCard : IEquatable<ReceiptCard>
    { 
        /// <summary>
        /// Title of the card
        /// </summary>
        ...
        /// </summary>
        /// <value>Array of Receipt Items</value>
        ...
        /// </summary>
        /// <value>Array of Fact Objects   Array of key-value pairs.</value>
        ...
        /// </summary>
        /// <value>This action will be activated when user taps on the card</value>
        [DataMember(Name="tap")]
        ...
        /// </summary>
        /// <value>Total amount of money paid (or should be paid)</value>
        ...
        /// </summary>
        /// <value>Total amount of TAX paid(or should be paid)</value>
        [DataMember(Name="tax")]
        ...
        /// </summary>
        /// <value>Total amount of VAT paid(or should be paid)</value>
        [DataMember(Name="vat")]
        ...
        /// </summary>
        /// <value>Set of actions applicable to the current card</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ReceiptCard)obj);
        }

        /// <summary>
        /// Returns true if ReceiptCard instances are equal
        /// </summary>
        /// <param name="other">Instance of ReceiptCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceiptCard other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Facts != null)
                    hashCode = hashCode * 59 + Facts.GetHashCode();
                    if (Tap != null)
                    hashCode = hashCode * 59 + Tap.GetHashCode();
                    if (Total != null)
        ...
        public static bool operator ==(ReceiptCard left, ReceiptCard right)
        {
