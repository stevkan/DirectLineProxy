...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CardImage : IEquatable<CardImage>
    { 
        /// <summary>
        /// URL Thumbnail image for major content property.
        /// </summary>
        /// <value>URL Thumbnail image for major content property.</value>
        [DataMember(Name="url")]
        ...
        /// </summary>
        /// <value>Image description intended for screen readers</value>
        [DataMember(Name="alt")]
        ...
        /// </summary>
        /// <value>Action assigned to specific Attachment.E.g.navigate to specific URL or play/open media content</value>
        [DataMember(Name="tap")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CardImage)obj);
        }

        /// <summary>
        /// Returns true if CardImage instances are equal
        /// </summary>
        /// <param name="other">Instance of CardImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardImage other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Alt != null)
                    hashCode = hashCode * 59 + Alt.GetHashCode();
                    if (Tap != null)
        ...
        public static bool operator ==(CardImage left, CardImage right)
        {
