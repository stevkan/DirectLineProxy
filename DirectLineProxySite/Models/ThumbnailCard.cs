...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ThumbnailCard : IEquatable<ThumbnailCard>
    { 
        /// <summary>
        /// Title of the card
        /// </summary>
        ...
        /// </summary>
        /// <value>Array of images for the card</value>
        ...
        /// </summary>
        /// <value>This action will be activated when user taps on the card itself</value>
        [DataMember(Name="tap")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ThumbnailCard)obj);
        }

        /// <summary>
        /// Returns true if ThumbnailCard instances are equal
        /// </summary>
        /// <param name="other">Instance of ThumbnailCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThumbnailCard other)
        {
        ...
        public static bool operator ==(ThumbnailCard left, ThumbnailCard right)
        {
